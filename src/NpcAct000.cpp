...
void ActNpc005(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 1: // Waiting
			...
			if (npc->act_wait >= 6 && npc->x - (224 * 0x200) < gMC.x && npc->x + (224 * 0x200) > gMC.x && npc->y - (160 * 0x200) < gMC.y && npc->y + (160 * 0x200) > gMC.y)
			{
				npc->ani_no = 1;
			}
			else
			...
			if (npc->act_wait >= 6 && npc->x - (96 * 0x200) < gMC.x && npc->x + (96 * 0x200) > gMC.x && npc->y - (160 * 0x200) < gMC.y && npc->y + (96 * 0x200) > gMC.y)
			{
				npc->act_no = 2;
				npc->ani_no = 0;
				npc->act_wait = 0;
...
void ActNpc006(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 2:
			// Wait 45 frames then move to the right
			if (++npc->act_wait > 45)
			{
				npc->act_no = 3;
				npc->ani_wait = 0;
		...
		case 4:
			// Wait 45 frames then move to the left
			if (++npc->act_wait > 45)
			{
				npc->act_no = 1;
				npc->ani_wait = 0;
