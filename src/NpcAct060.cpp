...
void ActNpc064(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 1: // Waiting
			...
			if (npc->act_wait >= 8 && npc->x - (224 * 0x200) < gMC.x && npc->x + (224 * 0x200) > gMC.x && npc->y - (160 * 0x200) < gMC.y && npc->y + (160 * 0x200) > gMC.y)
			{
				npc->ani_no = 1;
			}
			else
			...
			if (npc->act_wait >= 8 && npc->tgt_x >= 100 && npc->x - (128 * 0x200) < gMC.x && npc->x + (128 * 0x200) > gMC.x && npc->y - (160 * 0x200) < gMC.y && npc->y + (96 * 0x200) > gMC.y)
			{
				npc->act_no = 2;
				npc->ani_no = 0;
				npc->act_wait = 0;
